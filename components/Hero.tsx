...
import WalkRouteButton from "./WalkRouteButton";
        ...
        <div className="mx-auto w-full max-w-7xl px-4 pb-0 pt-28 sm:px-6 sm:pt-32 lg:px-8">
          <div className="mb-9 max-w-[760px] sm:mb-12">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <WalkRouteButton className="inline-flex max-w-full items-center gap-3 rounded-[10px] border border-white/12 bg-white/[0.08] px-4 py-3 text-left text-white shadow-[0_18px_48px_rgba(0,0,0,0.22)] backdrop-blur-md transition hover:border-[#c8f535]/60 hover:bg-white/[0.12]" />
            </div>
          </div>
